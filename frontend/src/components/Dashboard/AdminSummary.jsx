      ...
      <div className="mb-8">
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="mt-1 text-sm text-gray-600">Key metrics and statistics</p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-sm p-4">
            <div className="flex items-start justify-between">
              <div>
                ...
                <h3 className="text-2xl font-bold text-gray-900">{summary.data.totalEmployees}</h3>
              </div>
          ...
          <div className="bg-white rounded-lg shadow-sm p-4">
            <div className="flex items-start justify-between">
              <div>
                ...
                <h3 className="text-2xl font-bold text-gray-900">{summary.data.totalDepartments}</h3>
              </div>
          ...
          <div className="bg-white rounded-lg shadow-sm p-4">
            <div className="flex items-start justify-between">
              <div>
                ...
                <h3 className="text-2xl font-bold text-gray-900">Nrs. {summary.data.totalSalary}</h3>
              </div>
              <div className="bg-[#E7FAF5] p-2 rounded-lg">
            ...
            <div className="mt-2 flex items-center gap-2">
              <span className="text-xs text-[#00A76F] font-medium">On track</span>
          ...
          <div className="bg-white rounded-lg shadow-sm p-4">
            <div className="flex items-start justify-between">
              <div>
                ...
                <h3 className="text-2xl font-bold text-gray-900">{holidays.length}</h3>
              </div>
              <div className="bg-[#EFF4FB] p-2 rounded-lg">
      ...
      <div>
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="mt-1 text-sm text-gray-600">Overview of employee leaves</p>
          </div>
