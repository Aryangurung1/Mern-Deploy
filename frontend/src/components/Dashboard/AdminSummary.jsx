import {  Building2, CircleCheck, CircleX, FileText, Hourglass, User,  } from "lucide-react"
...
const AdminSummary = () => {
  return (
    <div className="p-6 ">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
        <SummaryCard icon={<User />} text="Events This Month" number={4} color="bg-teal-600"/>
        <SummaryCard icon={<User />} text="Events This Year" number={35} color="bg-teal-600"/>
        <SummaryCard icon={<User />} text="Holidays" number={15} color="bg-teal-600"/>
      </div>
      </div>
      <div className="mt-12">
